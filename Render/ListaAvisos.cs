...
namespace Render
{
    [Activity(Label = "Lista de Avisos Pendientes", Icon = "@mipmap/ic_render")]
    public class ListaAvisos : Activity
    {
        #region Campos
