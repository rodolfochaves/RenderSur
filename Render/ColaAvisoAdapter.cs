...
namespace Render
{
	public class ColaAvisoAdapter:BaseAdapter<ColaAvisoRender>
	{
		private Context mContext;
		private int mRowLayaout;
		private List<ColaAvisoRender> pAvisos;
		private int[] ColoresAlternos;
        private Color colortexto;
		public ColaAvisoAdapter(Context context, int rowLayout, List<ColaAvisoRender> avisos ){
			mContext = context;
		...
		public override ColaAvisoRender this[int position] => pAvisos[position];
		...
		public override View GetView(int position, View convertView, ViewGroup parent)
		{
            ...
            //switch (pAvisos[position].Estado_siniestro)
            //{
            //    default:
            //        if (ts.Days>=2)
            //        {
